...
const Product = ({ product, storeName, showImage = true, imagePath, daysToBeNext = 30, onLongPress }: Request) => {
    ...
    return (
        ...
        >
            <Content>
                ...
                <Text product={product} storeName={storeName} expiredOrNext={expiredOrNext} />
            </Content>
